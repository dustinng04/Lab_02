...
namespace ModelAndDAL.DbContexts;
...
public partial class FuminiHotelManagementContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        ...
        => optionsBuilder.UseSqlServer("Data Source=Riversy\\SQLEXPRESS;Initial Catalog=FUMiniHotelManagement;Integrated Security=True;Trust Server Certificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Customer>(entity =>
        {
            ...
            entity.HasIndex(e => e.EmailAddress, "UQ__Customer__49A147408F339A53").IsUnique();
